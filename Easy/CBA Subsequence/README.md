<h2><a href="https://www.geeksforgeeks.org/problems/cba-subsequence--170645/1?page=8&category=Sorting&sortBy=submissions">CBA Subsequence</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string, rearrange it in such a way that it has no subsequence as cba. If there are multiple answers return the lexicographically smallest one.</span></p>
